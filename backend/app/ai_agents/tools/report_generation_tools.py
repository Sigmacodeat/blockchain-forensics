...
from app.utils.security import validate_string_length, sanitize_filename
...
async def export_risk_analysis_tool(
    ...
    try:
        ...
        if format.lower() == "json":
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                f.write(f"RISK ANALYSIS REPORT\n\n")
...
async def generate_pdf_report(trace_id: str, trace_data: dict, include_charts: bool) -> str:
    ...
    with open(file_path, 'w', encoding='utf-8') as f:
        ...
        f.write("-" * 60 + "\n")
        f.write(f"Generated by: AI Forensic Agent\n")
        f.write(f"Timestamp: {datetime.utcnow().isoformat()}\n")
        f.write(f"Method: Automated Blockchain Trace\n")
        f.write(f"Verification: SHA256 hash placeholder\n")
