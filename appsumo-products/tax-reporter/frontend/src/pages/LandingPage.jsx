    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { name: 'Tier 1', price: 99, features: ['Feature 1', 'Feature 2'] },
            { name: 'Tier 2', price: 179, features: ['All Tier 1', 'Feature 3', 'Feature 4'] },
            { name: 'Tier 3', price: 299, features: ['All Tier 2', 'Feature 5', 'Unlimited'] }
          ].map(tier => (
